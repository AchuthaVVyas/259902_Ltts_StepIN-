...
def register():
    ...
    register_screen.configure(bg='#49A')
    global username
    global password
    ...
    username_lable = Label(register_screen, text="Username * ", bg='#48A')
    username_lable.pack()
    username_entry = Entry(register_screen, textvariable=username)
    username_entry.pack()
    password_lable = Label(register_screen, text="Password * ", bg='#48A')
    password_lable.pack()
...
def delete_login_success():
    ...
    main_screen.destroy()
    os.system('F:\python_project\Eshopping\eshopee.py')
...
def main_account_screen():
    ...
    main_screen.configure(bg="#49A")
    bg = PhotoImage(
        file="F:\python_project\Eshopping\images\\background.png")
